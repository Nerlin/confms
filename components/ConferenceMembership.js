...
export default function ConferenceMembership({ slug }) {
  return (
    <aside className={"bg-white border border-gray-100 shadow-md ml-auto mt-4 min-w-max"}>
      <header>
        <ul>
          ...
          <li className={"px-2 pr-16 py-2"}>
            <Link href={`/conferences/${slug}/info`}>
              <a className={"inline-flex items-center"} href={`/conferences/${slug}/info`}>
                <FontAwesomeIcon className={"mr-2 text-blue-600 text-base"} icon={faInfo} fixedWidth />
          ...
          <li className={"px-2 pr-16 py-2"}>
            <Link href={`/conferences/${slug}/materials`}>
              <a className={"inline-flex items-center"} href={`/conferences/${slug}/materials`}>
                <FontAwesomeIcon className={"mr-2 text-blue-600 text-base"} icon={faFileArchive} fixedWidth />
